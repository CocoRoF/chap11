"""
part1_regacy - Assistants API Code Interpreter 테스트

테스트 항목:
1. 간단한 수학 코드 실행 (2+2)
2. matplotlib 차트 생성 및 파일 다운로드
"""
...
# 프로젝트 루트 기준으로 import 할 수 있도록 path 설정
...
"""
    ...
    # 이미지 파일 확장자 확인 (png 또는 jpeg가 예상됨)
...
if __name__ == "__main__":
    ...
    print("🚀 Assistants API Code Interpreter 테스트 시작")
    print(f"{'=' * 60}\n")

    # 클라이언트 생성은 한 번만 (Assistant + Thread 생성)
